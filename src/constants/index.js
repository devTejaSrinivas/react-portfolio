...
export const ABOUT_TEXT = `With a solid foundation in the MERN stack (MongoDB, Express.js, React, and Node.js), I excel at creating dynamic and responsive web applications. My proficiency extends to deploying and managing projects using Vercel, ensuring seamless and scalable deployments.\n I possess extensive experience with various databases, which enables me to design and manage efficient data architectures. Familiarity with Version Control Systems (VCS) like Git equips me with the skills to maintain code quality and manage collaborative projects effectively.\n Beyond my technical expertise, I am a dedicated team player known for my strong communication and problem-solving abilities, making me a valuable asset in collaborative environments. My interpersonal skills and enthusiasm for continuous learning drive me to keep up with emerging technologies and deliver innovative solutions.`;
